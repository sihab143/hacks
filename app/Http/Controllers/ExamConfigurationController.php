...
class ExamConfigurationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home.examConfig',['acdemicYear' => $this->acdemicYear, 'className' => $this->className, 'examType' => $this->examType, 'groups' => $this->group]);
    }
    ...
    {
        ExamConfig::examSet($request);
        return redirect('/exam-config')->with('message', 'set exam successfully');
    }
}
